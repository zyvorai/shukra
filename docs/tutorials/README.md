...
9. [Investigate after the fact](09-after-the-fact.md) — a verdict for a past time from stored snapshots, who took the CPU, and one incident bundle to attach to a ticket.
