...
const heroes: Partial<Record<Page, { eyebrow: string; title: string; lede: string; tint?: HeroTint }>> = {
  ...
  kvm: { eyebrow: 'Diagnostics', title: 'KVM exits, counted.', lede: 'Per thread group and exit reason. Not one event per exit.', tint: 'green' },
  sched: { eyebrow: 'Diagnostics', title: 'Scheduler delay.', lede: 'On-CPU time and wakeup delay for QEMU threads.', tint: 'amber' },
  block: { eyebrow: 'Diagnostics', title: 'Block latency.', lede: 'p50 and p99 from a log2 histogram on the QEMU I/O thread.', tint: 'amber' },
